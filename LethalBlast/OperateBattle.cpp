	...
	EnemyData* pEnemyDatas, CustomVertex* pMouseCursorVertices)
{
	...
	if (initUnionTex)
	{
		...
		case 0:
			...
			LoadOriDeck(pWMWordDatas, &pWMDeck[selectedDeck], "Files/Deck/水晶洞窟/WeaponMasterDeck00.csv");

			break;

		case 1:

			LoadOriDeck(pMKWordDatas, &pMKDeck[selectedDeck], "Files/Deck/古代遺跡/MagicKnightDeck02.csv");
			LoadOriDeck(pWMWordDatas, &pWMDeck[selectedDeck], "Files/Deck/古代遺跡/WeaponMasterDeck02.csv");
