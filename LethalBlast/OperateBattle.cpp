	...
	EnemyData* pEnemyDatas, CustomVertex* pMouseCursorVertices)
{
	...
	if (initUnionTex)
	{
		...
		{
		case 0:
			LoadOriDeck(pMKWordDatas, &pMKDeck[selectedDeck], "Files/Deck/水晶洞窟/MagicKnightDeck00.csv");
			LoadOriDeck(pWMWordDatas, &pWMDeck[selectedDeck], "Files/Deck/水晶洞窟/MagicKnightDeck00.csv");

			break;

		case 1:

			LoadOriDeck(pMKWordDatas, &pMKDeck[selectedDeck], "Files/Deck/古代遺跡/MagicKnightDeck01.csv");
			LoadOriDeck(pWMWordDatas, &pWMDeck[selectedDeck], "Files/Deck/古代遺跡/MagicKnightDeck01.csv");

			break;

		case 2:

			LoadOriDeck(pMKWordDatas, &pMKDeck[selectedDeck], "Files/Deck/黒森ノ館/MagicKnightDeck02.csv");
			LoadOriDeck(pWMWordDatas, &pWMDeck[selectedDeck], "Files/Deck/黒森ノ館/MagicKnightDeck02.csv");
