...
//	ImagesCustomVertex* pHandWordCollisionsVertex, ImagesCustomVertex* pMagicKnightActionCollisionsVertex, TEXTUREID* mKWordTex, 
...
//		RoadTexture("Texture/MainGame/mainBG.png", &stageTexIds[森]);
//		RoadTexture("Texture/MainGame/mainBG.png", &stageTexIds[遺跡]);
//		RoadTexture("Texture/MainGame/mainBG.png", &stageTexIds[洞窟]);
//		RoadTexture("Texture/MainGame/Enemy/Robot.png", &enemyTexIds[エーレ・ツヴァイ人型]);
...
//
//		SetFont(DISPLAY_WIDTH / 70, DISPLAY_WIDTH / 48, "HGP明朝B", &fontId[ENEMY_DATA_FONT], 0);
//		SetFont(DISPLAY_WIDTH / 35, DISPLAY_WIDTH / 24, "HGP明朝B", &fontId[ENEMY_ACTION_FONT], 0);
//
//		frameCount = 0;
//	}
//
...
//		DrawImage(pHandWordCollisionsVertex[handWord].ImageVertex, mKWordTex[(pMagicKnightPlayingDeck->m_handWordId[handWord])]);
//	}
//
...
//		{
//			DrawImage(pMagicKnightActionCollisionsVertex[actionComponentWord].ImageVertex, mKWordTex[(pMagicKnightAction->m_componentWordIds[actionComponentWord])]);
//		}
//	}
//
//	for (int effect = 0; effect < SELECT_EFFECT_MAX; ++effect)
